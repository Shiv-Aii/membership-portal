...
function Card() {
  ...
  async function pdf() {
    ...
    pdf.addImage(img, "PNG", 0, 0, 85.6, 53.9);

    pdf.save(`${a?.membership_no || "member"}-PVC.pdf`);
  }
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-5">
          ...
          <div className="flex gap-2">
            ...
            >
              {locked ? "Unlock Design" : "Lock Design"}
            </button>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div>
            ...
            >
              ...
              <div className="p-4 flex gap-4">
                <div className="w-20 h-24 rounded-lg overflow-hidden bg-slate-200">
                  {a.photo_url && (
                    <img
                      src={a.photo_url}
          ...
          <div className="bg-white rounded-2xl p-5 card-shadow">
            ...
            <div className="mt-6">
              ...
              <div className="pvc mt-2 rounded-xl border bg-white grid place-items-center text-center">
                <b>
                  ನಮ್ಮ ಸಂಘಟನೆ — ನಮ್ಮ ಬಲ
                </b>
